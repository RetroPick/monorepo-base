...
SELECT market_id, event_id, condition_id, slug, question, description, status, end_at, enable_order_book, neg_risk, source, upstream_updated_at, content_hash, payload, observed_at, created_at, updated_at
...
SELECT market_id, description, resolution_source_name, resolution_source_url, content_hash, upstream_updated_at, observed_at, created_at, updated_at
...
SELECT source, stream, cursor, high_watermark, last_success_at, metadata, updated_at
...
ON CONFLICT (event_id) DO UPDATE SET
    ...
    updated_at = NOW()
RETURNING event_id, slug, title, description, status, start_at, end_at, source, upstream_updated_at, content_hash, payload, observed_at, created_at, updated_at
`
...
ON CONFLICT (market_id) DO UPDATE SET
    ...
    observed_at = EXCLUDED.observed_at,
    updated_at = NOW()
RETURNING market_id, event_id, condition_id, slug, question, description, status, end_at, enable_order_book, neg_risk, source, upstream_updated_at, content_hash, payload, observed_at, created_at, updated_at
`
...
ON CONFLICT (outcome_id) DO UPDATE SET
    ...
    observed_at = EXCLUDED.observed_at,
    updated_at = NOW()
RETURNING outcome_id, market_id, upstream_token_id, outcome_index, name, price, winner, observed_at, created_at, updated_at
`
...
ON CONFLICT (market_id) DO UPDATE SET
    ...
    observed_at = EXCLUDED.observed_at,
    updated_at = NOW()
RETURNING market_id, description, resolution_source_name, resolution_source_url, content_hash, upstream_updated_at, observed_at, created_at, updated_at
`
...
ON CONFLICT (source, stream) DO UPDATE SET
    ...
    updated_at = NOW()
RETURNING source, stream, cursor, high_watermark, last_success_at, metadata, updated_at
`
