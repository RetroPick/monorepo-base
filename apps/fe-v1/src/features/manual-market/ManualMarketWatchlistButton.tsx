...
type ManualMarketWatchlistButtonProps = {
...
export function ManualMarketWatchlistButton({
  isBookmarked,
  busy,
  watchlistLoading,
  onToggle,
  className,
}: ManualMarketWatchlistButtonProps) {
  return (
    <Button
      type="button"
      variant="outline"
...
export function ConnectedManualMarketWatchlistButton({ templateId, className }: ConnectedProps) {
