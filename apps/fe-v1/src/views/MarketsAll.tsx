...
import { PolymarketDiscoverPanel } from "@/features/markets/components/PolymarketDiscoverPanel";
import {
  countByAsset,
  countByHorizon,
  HORIZON_META,
...
const MarketsAll = ({ initialVertical = "polymarket" }: MarketsAllProps = {}) => {
  ...
  if (activeVertical === "polymarket") {
    return <PolymarketDiscoverPanel />;
  }
