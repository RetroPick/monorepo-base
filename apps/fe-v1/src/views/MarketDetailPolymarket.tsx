...
import { DataStateBanner } from "@/features/markets/components/DataState";
...
export default function MarketDetailPolymarket() {
  ...
  if (!isPolymarketResourceId(decodedId) && !market.isLoading) {
    return null;
  }
          ...
          <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border border-border/70 bg-card p-5">
                ...
                <p className="mb-2 text-xs text-muted-foreground">Snapshot polling — not realtime</p>
