...
const Login = () => {
    ...
    const targetChainId = Number(appDefaultNetwork.id);
    ...
    const handleEnableTrading = async () => {
        try {
            ...
            const signRequest = { domain, types, primaryType: "SessionSignIn", message } as unknown as Parameters<typeof signTypedDataAsync>[0];
            const signature = await signTypedDataAsync(signRequest);
            if (isDevRuntime()) console.log("Derived Session Signature:", signature);
