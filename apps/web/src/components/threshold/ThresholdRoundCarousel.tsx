...
export function ThresholdRoundCarousel({ rounds }: ThresholdRoundCarouselProps) {
  ...
  useEffect(() => {
    ...
    const targetScrollLeft = nextCard.offsetLeft - container.clientWidth / 2 + nextCard.clientWidth / 2;
  ...
  return (
    <div className="relative py-2">
      <button
        ...
        aria-label="Scroll threshold rounds left"
      >
        &lt;
      </button>
      <button
        ...
        aria-label="Scroll threshold rounds right"
      >
        &gt;
      </button>
      <div
