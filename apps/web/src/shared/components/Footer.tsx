...
import { IconDiscord, IconTelegram, IconX } from "@/shared/components/footer-social-icons";
import { siteLinks, socialLinks } from "@/shared/config/siteLinks";
...
export default function Footer() {
  ...
  return (
    <>
      <div className="shrink-0" style={{ height: "calc(2.75rem + env(safe-area-inset-bottom, 0px))" }} aria-hidden />
      <footer
        className={cn(
      ...
      >
        <div className="mx-auto flex h-11 max-w-screen-2xl items-center justify-between gap-2 px-5 sm:gap-4 lg:px-10 min-[360px]:gap-3">
          <div className="flex min-w-0 items-center gap-2 sm:gap-2.5">
            ...
            <span className="min-w-0 truncate text-muted-foreground">version {pkg.version}</span>
          </div>
