export const ORDER_TICKET_TITLE = "Order ticket";
export const ORDER_TICKET_LIMIT_LABEL = "Limit order";
export const ORDER_SIDE_BUY = "Buy";
export const ORDER_SIDE_SELL = "Sell";
export const ORDER_FIELD_PRICE = "Limit price";
export const ORDER_FIELD_SIZE = "Size";
export const ORDER_PREVIEW_CTA = "Preview order";
export const ORDER_PREVIEWING = "Preparing preview…";
export const ORDER_SIGNING = "Awaiting wallet signature…";
...
export const ORDER_RECONCILE_TIMEOUT =
  "We could not confirm your order yet. It may still be processing — check open orders before submitting again.";
export const ORDER_REJECTED = "Order was rejected by the venue.";
export const ORDER_PREVIEW_MODAL_TITLE = "Review order before signing";
export const ORDER_PREVIEW_MODAL_CONFIRM = "Sign in wallet";
export const ORDER_PREVIEW_MODAL_CANCEL = "Back to ticket";
...
export const ORDER_STALE_MARKETABLE_BLOCKED =
  "This limit price would execute immediately against a stale book. Refresh the book or use a resting price.";
export const ORDER_STALE_RESTING_WARNING =
  "Order book data may be stale. Resting limits are allowed with caution.";
