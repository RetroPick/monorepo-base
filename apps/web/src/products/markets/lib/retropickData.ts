...
const CATEGORY_FALLBACK_ASSET: Record<string, string> = {
  ...
  Climate: '/images/markets/climate/climate.webp',
  Politics: '/images/markets/politics/politics.webp',
}
...
export const MARKETS: Market[] = [
  ...
  },
  {
    ...
    volume: '$780K Vol.',
    liquidity: '$420K',
    image: '/images/markets/crypto/ethereum.webp',
    participants: '18.3K',
    timeLeft: '5m remaining',
    trend: 'down',
  ...
  },
  {
    ...
    icon: 'AI',
    options: [
      { label: 'Q4 2026', percentage: 71 },
      { label: 'Q3 2026', percentage: 29 },
    ],
  },
  {
    id: 'strait-of-hormuz',
  ...
  },
  {
    ...
    icon: 'NVDA',
    options: [
      { label: 'Yes by Q4', percentage: 77 },
      { label: 'No / After 2027', percentage: 23 },
    ],
  },
  {
    id: 'btc-150k-2027',
  ...
  {
    id: 'james-fishback-vote-share',
    question: 'James Fishback vote share in 2026 Florida Republican Governor Primary?',
    category: 'Economics',
    marketType: 'MULTIPLE_CHOICE',
    yes: 50,
    volume: '$165K',
    ...
    icon: 'POL',
    options: [
      { label: 'Fishback <10%', percentage: 50 },
      { label: 'Fishback 10-15%', percentage: 35 },
    ]
  },
  {
    id: 'florida-gov-margin-victory',
    question: 'Florida Republican Governor Primary Margin of Victory',
    category: 'Economics',
    marketType: 'MULTIPLE_CHOICE',
    yes: 51,
    volume: '$89K',
    ...
    icon: 'POL',
    options: [
      { label: 'Donalds 40%+', percentage: 51 },
      { label: 'Donalds 35-40%', percentage: 24 },
    ]
  },
  {
    id: 'florida-gov-election-winner',
    question: 'Florida Governor Election Winner',
    category: 'Economics',
    marketType: 'MULTIPLE_CHOICE',
    yes: 83,
    volume: '$310K',
    ...
    timeLeft: 'Nov 3, 2026',
    trend: 'up',
    chart: series(83, true),
    verified: true,
    icon: 'POL',
    options: [
      { label: 'Republican', percentage: 83 },
      { label: 'Democrat', percentage: 19 },
    ]
  },
  {
    id: 'clarity-act-law-2026',
