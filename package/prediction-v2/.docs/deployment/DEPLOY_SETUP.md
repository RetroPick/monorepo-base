...
- `.docs/deployment/ProductionChecklist.md` (production gate checklist)
- [`rollingMarket.md`](../../rollingMarket.md) (rolling mode + threat model summary)
...
Pre-flight requirements are in `.docs/deployment/ProductionChecklist.md`.
...
Reference: `.docs/deployment/ProductionChecklist.md` and [`rollingMarket.md`](../../rollingMarket.md).