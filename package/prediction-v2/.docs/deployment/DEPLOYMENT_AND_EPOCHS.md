...
Templates can use [`ExecutionMode`](src/types/MarketTypes.sol) **`Manual`** (default, Anchor-style discrete txs) or **`Rolling`** (Pancake-style rolling pipeline). Design reference: [`rollingMarket.md`](../../rollingMarket.md).
...
Reference Pancake V3 prediction shape (Chainlink, single market): [`reference/PancakePredictionV3.sol`](reference/PancakePredictionV3.sol). See [`rollingMarket.md`](../../rollingMarket.md).
