...
if RPC_URL="http://127.0.0.1:8545" EXPECTED_CHAIN_ID=31337 SEQUENCER_FEED=0x0000000000000000000000000000000000000000 ADMIN=0x0000000000000000000000000000000000000001 TREASURY=0x0000000000000000000000000000000000000002 WORKER=0x0000000000000000000000000000000000000003 DEFAULT_SETTLEMENT_FEE_BPS=75 MAX_SWITCH_FEE_BPS=200 MAX_OUTCOMES=8 ORACLE_MAX_DELAY_SECONDS=3600 ORACLE_MAX_CONFIDENCE_BPS=0 ./scripts/deploy-testnet.sh >/tmp/testnet_stake.out 2>&1; then
