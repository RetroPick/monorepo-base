 ...
 * Deployed stake token address in `packages/legacy/contracts/registry.celo-alfajores.json`
 * is the source of truth — tests assert this map stays aligned.
 */
export const ALFAJORES_REGISTRY_PATH = "packages/legacy/contracts/registry.celo-alfajores.json";
