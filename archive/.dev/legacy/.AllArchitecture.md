...
> **Canonical cross-stack reference.** Drill-down docs: [backend](backend/README.md), [contracts](../contracts/legacy-pool-v1/currentSmartContract.md), [ABI map](abi-map.md), [pipeline](pipeline/README.md). Machine-readable companions: [.AllArchitecture.json](.AllArchitecture.json) (summary registry), [knowledge-graph.json](knowledge-graph.json) (full graph).
...
### 4.1 On-chain (`contracts/legacy-pool-v1`)
...
| ID | Component | Domain | Role | Goal | Path |
|----|-----------|--------|------|------|------|
| `frontend.fe-v1.app` | fe-v1 user app | trading-settlement | consumer | Wallet-first market trading UX | `apps/web/` |
| `frontend.fe-v1.router` | React Router SPA | realtime-ux | utility | Client routes inside Next shell | `apps/web/src/App.tsx` |
| `frontend.fe-v1.api` | retropickApi | realtime-ux | consumer | Typed REST client to Go API | `apps/web/src/lib/api/retropickApi.ts` |
| `frontend.fe-v1.ws` | useIndexerWebSocket | realtime-ux | consumer | WS subscribe + React Query invalidation | `apps/web/src/hooks/useIndexerWebSocket.ts` |
| `frontend.fe-v1.chain` | marketEngine.ts | trading-settlement | consumer | wagmi/viem contract hooks | `apps/web/src/lib/contracts/marketEngine.ts` |
| `frontend.fe-v1.trade` | ManualTradeCard | trading-settlement | consumer | Deposit/switch UI for manual epochs | `apps/web/src/features/manual-market/` |
| `frontend.fe-v1.markets` | MarketsAll / ChainMarketDetail | market-lifecycle | consumer | Market discovery and detail | `apps/web/src/views/` |
| `frontend.fe-v1.portfolio` | Portfolio | trading-settlement | consumer | Positions, claims, PnL summary | `apps/web/src/views/Portfolio.tsx` |
| `frontend.ops.app` | ops dashboard | operator-governance | consumer | Internal protocol operations UI | `apps/ops-web/` |
| `frontend.ops.prepare` | Prepare explorer | operator-governance | utility | Privileged tx preparation catalog | `apps/ops-web/src/app/prepare/` |
| `frontend.ops.live` | LiveOpsContext | operator-governance | consumer | Explicit live RPC refresh actions | `apps/ops-web/src/components/LiveOpsContext.tsx` |
| `frontend.docs` | docs site | deployment-devops | utility | Public MDX documentation | `apps/docs/` |
| `frontend.landing` | retropick-landing | deployment-devops | utility | Marketing + Supabase waitlist | `apps/landing-web/` |
...
| `infra.abi` | packages/legacy/abi | deployment-devops | canonical | Published contract ABIs | `packages/legacy/abi/` |

---

## 5. Smart Contracts — Architecture & Flows

**Canonical tree:** [`contracts/legacy-pool-v1/`](../contracts/legacy-pool-v1/).
...
Deep reference: [`currentSmartContract.md`](../contracts/legacy-pool-v1/currentSmartContract.md).
...
sequenceDiagram
  ...
  participant WS as Client web/ops-web
...
**Monorepo:** pnpm 10 + Turborepo. Contracts: Foundry in `contracts/legacy-pool-v1`. Operator CLI: `retro` / `pnpm retro`.
...
| Smart contracts (deep) | [`contracts/legacy-pool-v1/currentSmartContract.md`](../contracts/legacy-pool-v1/currentSmartContract.md) |
| Rolling markets | [`contracts/legacy-pool-v1/rollingMarket.md`](../contracts/legacy-pool-v1/rollingMarket.md) |
...
| Operator runbook | [`contracts/legacy-pool-v1/.operator/.runbook.md`](../contracts/legacy-pool-v1/.operator/.runbook.md) |
