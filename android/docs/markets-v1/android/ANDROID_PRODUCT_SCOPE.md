...
Native Android Markets-only scope per .dev/ANDROID_MARKETS.md.
...
`apps/android/` README-only; implementation PHASE-5.

## 6. Target design

Kotlin + Jetpack Compose; consumes Markets OpenAPI only.
