...
Specify notifications and background work for RetroPick Markets V1.
...
Implementation-grade design for notifications and background work aligned with R0–R3 monorepo.
