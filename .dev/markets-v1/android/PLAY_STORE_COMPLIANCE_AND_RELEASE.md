# PLAY STORE COMPLIANCE AND RELEASE
...
| Declaration | Content |
|-------------|---------|
| Financial features | Cryptocurrency trading / prediction markets |
| Data safety | Wallet address, trading activity, device IDs |
| Content rating | Gambling-adjacent questionnaire accurate |
| Target audience | Adults per legal guidance |
...
[Blockchain policy](https://support.google.com/googleplay/android-developer/answer/13607354),
[Crypto exchange requirements](https://support.google.com/googleplay/android-developer/answer/16329703).

### Legal gates (pre-production)

- [ ] Legal opinion per distributed country
- [ ] Play financial declaration submitted
- [ ] Upstream/partner eligibility documented
- [ ] Store listing without guaranteed-return claims
- [ ] Age rating, terms, fees, risk disclosures linked
- [ ] Server-side geo eligibility enforced
- [ ] Remote order-submission kill switch tested
...
- Upload key in CI secret store; not in repo.
- SBOM generated per release (`cyclonedx-gradle-plugin`).
- Dependency vulnerability scan (Gradle + GitHub).

### Build artifacts

| Output | Retention |
|--------|-----------|
| AAB | Play + internal archive 2y |
| Mapping file | Crash deobfuscation |
| SBOM | Compliance archive |

### Store listing assets

- Screenshots: phone + 7" tablet + 10" tablet
- Feature graphic, icon per brand guidelines
- Short/full description with risk disclaimer
- No misleading win guarantees

### In-app purchases

Play Billing **not** used for trades. If premium analytics subscription ships:

- Separate SKU review under Payments policy
- Entitlement via BFF, not client-only

### Country distribution

Align Play geo with `/markets/eligibility` — server is authoritative if they diverge.

### Incident response

| Incident | Action |
|----------|--------|
| Critical trading bug | Halt rollout; remote kill switch |
| Policy rejection | Stop distribution; legal review |
| Wallet SDK CVE | Forced update or disable vendor |

### Versioning

Semantic `versionName`; monotonic `versionCode`.
Minimum supported version enforced via capabilities endpoint.

### Web parity

| Topic | Web | Android |
|-------|-----|---------|
| Deployment | Vercel/hosted | Play tracks |
| Feature flags | Capabilities API | Same |
| Kill switch | Server | Same |
| Terms acceptance | Session | Same + store policies |
...
| Distribution | Web deploy | Play staged rollout | Separate compliance path |
...
- Financial features declaration checklist.
- Play App Signing + SBOM process.
- Kill switch tested.
- Country alignment with eligibility API.
...
### A.1 play-release — Overview

**Overview** for `play-release`.
...
- Deep dive 1 for play-release: Overview implementation checklist item 1.
- Deep dive 1 for play-release: Overview implementation checklist item 2.
- Deep dive 1 for play-release: Overview implementation checklist item 3.
- Deep dive 1 for play-release: Overview implementation checklist item 4.
- Deep dive 1 for play-release: Overview implementation checklist item 5.

### A.2 play-release — Module ownership

**Module ownership** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 2 for play-release: Module ownership implementation checklist item 1.
- Deep dive 2 for play-release: Module ownership implementation checklist item 2.
- Deep dive 2 for play-release: Module ownership implementation checklist item 3.
- Deep dive 2 for play-release: Module ownership implementation checklist item 4.
- Deep dive 2 for play-release: Module ownership implementation checklist item 5.

### A.3 play-release — API mapping

**API mapping** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 3 for play-release: API mapping implementation checklist item 1.
- Deep dive 3 for play-release: API mapping implementation checklist item 2.
- Deep dive 3 for play-release: API mapping implementation checklist item 3.
- Deep dive 3 for play-release: API mapping implementation checklist item 4.
- Deep dive 3 for play-release: API mapping implementation checklist item 5.

### A.4 play-release — State machine

**State machine** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 4 for play-release: State machine implementation checklist item 1.
- Deep dive 4 for play-release: State machine implementation checklist item 2.
- Deep dive 4 for play-release: State machine implementation checklist item 3.
- Deep dive 4 for play-release: State machine implementation checklist item 4.
- Deep dive 4 for play-release: State machine implementation checklist item 5.

### A.5 play-release — Caching

**Caching** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 5 for play-release: Caching implementation checklist item 1.
- Deep dive 5 for play-release: Caching implementation checklist item 2.
- Deep dive 5 for play-release: Caching implementation checklist item 3.
- Deep dive 5 for play-release: Caching implementation checklist item 4.
- Deep dive 5 for play-release: Caching implementation checklist item 5.

### A.6 play-release — Error UX

**Error UX** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 6 for play-release: Error UX implementation checklist item 1.
- Deep dive 6 for play-release: Error UX implementation checklist item 2.
- Deep dive 6 for play-release: Error UX implementation checklist item 3.
- Deep dive 6 for play-release: Error UX implementation checklist item 4.
- Deep dive 6 for play-release: Error UX implementation checklist item 5.

### A.7 play-release — Testing hooks

**Testing hooks** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 7 for play-release: Testing hooks implementation checklist item 1.
- Deep dive 7 for play-release: Testing hooks implementation checklist item 2.
- Deep dive 7 for play-release: Testing hooks implementation checklist item 3.
- Deep dive 7 for play-release: Testing hooks implementation checklist item 4.
- Deep dive 7 for play-release: Testing hooks implementation checklist item 5.

### A.8 play-release — Rollout flags

**Rollout flags** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 8 for play-release: Rollout flags implementation checklist item 1.
- Deep dive 8 for play-release: Rollout flags implementation checklist item 2.
- Deep dive 8 for play-release: Rollout flags implementation checklist item 3.
- Deep dive 8 for play-release: Rollout flags implementation checklist item 4.
- Deep dive 8 for play-release: Rollout flags implementation checklist item 5.

### A.9 play-release — Performance budget

**Performance budget** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 9 for play-release: Performance budget implementation checklist item 1.
- Deep dive 9 for play-release: Performance budget implementation checklist item 2.
- Deep dive 9 for play-release: Performance budget implementation checklist item 3.
- Deep dive 9 for play-release: Performance budget implementation checklist item 4.
- Deep dive 9 for play-release: Performance budget implementation checklist item 5.

### A.10 play-release — Accessibility

**Accessibility** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 10 for play-release: Accessibility implementation checklist item 1.
- Deep dive 10 for play-release: Accessibility implementation checklist item 2.
- Deep dive 10 for play-release: Accessibility implementation checklist item 3.
- Deep dive 10 for play-release: Accessibility implementation checklist item 4.
- Deep dive 10 for play-release: Accessibility implementation checklist item 5.

### A.11 play-release — Security controls

**Security controls** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 11 for play-release: Security controls implementation checklist item 1.
- Deep dive 11 for play-release: Security controls implementation checklist item 2.
- Deep dive 11 for play-release: Security controls implementation checklist item 3.
- Deep dive 11 for play-release: Security controls implementation checklist item 4.
- Deep dive 11 for play-release: Security controls implementation checklist item 5.

### A.12 play-release — Observability

**Observability** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 12 for play-release: Observability implementation checklist item 1.
- Deep dive 12 for play-release: Observability implementation checklist item 2.
- Deep dive 12 for play-release: Observability implementation checklist item 3.
- Deep dive 12 for play-release: Observability implementation checklist item 4.
- Deep dive 12 for play-release: Observability implementation checklist item 5.

### A.13 play-release — Migration notes

**Migration notes** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 13 for play-release: Migration notes implementation checklist item 1.
- Deep dive 13 for play-release: Migration notes implementation checklist item 2.
- Deep dive 13 for play-release: Migration notes implementation checklist item 3.
- Deep dive 13 for play-release: Migration notes implementation checklist item 4.
- Deep dive 13 for play-release: Migration notes implementation checklist item 5.

### A.14 play-release — FAQ

**FAQ** for `play-release`.
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 14 for play-release: FAQ implementation checklist item 1.
- Deep dive 14 for play-release: FAQ implementation checklist item 2.
- Deep dive 14 for play-release: FAQ implementation checklist item 3.
- Deep dive 14 for play-release: FAQ implementation checklist item 4.
- Deep dive 14 for play-release: FAQ implementation checklist item 5.

### A.15 play-release — Overview
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 15 for play-release: Overview implementation checklist item 1.
- Deep dive 15 for play-release: Overview implementation checklist item 2.
- Deep dive 15 for play-release: Overview implementation checklist item 3.
- Deep dive 15 for play-release: Overview implementation checklist item 4.
- Deep dive 15 for play-release: Overview implementation checklist item 5.

### A.16 play-release — Module ownership
...
- Main thread must not perform network or disk I/O.
- Feature flags read from /markets/capabilities on cold start and resume.
- Deep dive 16 for play-release: Module ownership implementation checklist item 1.
- Deep dive 16 for play-release: Module ownership implementation checklist item 2.
- Deep dive 16 for play-release: Module ownership implementation checklist item 3.
- Deep dive 16 for play-release: Module ownership implementation checklist item 4.
- Deep dive 16 for play-release: Module ownership implementation checklist item 5.
