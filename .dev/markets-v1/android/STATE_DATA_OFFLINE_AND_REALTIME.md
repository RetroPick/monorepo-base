...
Specify state data offline and realtime for RetroPick Markets V1.
...
Implementation-grade design for state data offline and realtime aligned with R0–R3 monorepo.
