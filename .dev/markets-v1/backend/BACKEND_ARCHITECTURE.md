...
Go BFF architecture for Markets: handlers, services, upstream clients.
...
`apps/backend/internal/markets/` implements read surface with Gamma client.

## 6. Target design

Layered: handler → service → gamma/clob/indexer; no legacy domain imports.
