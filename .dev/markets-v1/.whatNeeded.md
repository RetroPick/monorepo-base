...
**Next ops milestone.** Rent Singapore/Tokyo VPS, deploy `markets-api` + Postgres, inject BLK-001 env vars, curl `/eligibility` until `eligible: true`, file [MKT-P2-BLK001-staging-proof.md](agent-harness/verification/PHASE-2/MKT-P2-BLK001-staging-proof.md).
...
| Item | State |
|------|-------|
| `current_phase` | **PHASE-2** — [implementation-manifest.yaml](agent-harness/implementation-manifest.yaml) |
...
| Builder / trading | **Not needed yet** — `order_submit: false`; [BLK-004](agent-harness/BLOCKERS_AND_HUMAN_APPROVALS.md) |
...
Evidence: [MKT-P2-BLK001-ops-staging-checklist.md](agent-harness/verification/PHASE-2/MKT-P2-BLK001-ops-staging-checklist.md) §4 → `MKT-P2-BLK001-staging-proof.md`.
...
- Human gate: Builder fee configuration at PHASE-7 — [BLOCKERS §4](agent-harness/BLOCKERS_AND_HUMAN_APPROVALS.md).
- Blocker: [BLK-003](agent-harness/BLOCKERS_AND_HUMAN_APPROVALS.md) (Builder production credentials).
...
| Topic | Document |
|-------|----------|
| BLK-001 staging steps | [MKT-P2-BLK001-ops-staging-checklist.md](agent-harness/verification/PHASE-2/MKT-P2-BLK001-ops-staging-checklist.md) |
| Local rehearsal evidence | [MKT-P2-BLK001-local-rehearsal-evidence.md](agent-harness/verification/PHASE-2/MKT-P2-BLK001-local-rehearsal-evidence.md) |
| Active blockers | [BLOCKERS_AND_HUMAN_APPROVALS.md](agent-harness/BLOCKERS_AND_HUMAN_APPROVALS.md) |
...
| Phase advance gate | [MKT-P2-phase-advance-ready.md](agent-harness/verification/PHASE-2/MKT-P2-phase-advance-ready.md) |

---

**Note:** This file does not advance `current_phase` or clear blockers. Harness truth lives in [implementation-manifest.yaml](agent-harness/implementation-manifest.yaml) and [BLOCKERS_AND_HUMAN_APPROVALS.md](agent-harness/BLOCKERS_AND_HUMAN_APPROVALS.md).
