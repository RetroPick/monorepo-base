...
- **Current task:** MKT-P1-004 — Catalog synchronization and checkpointing
...
- **Commands/tests run:** `go test ./internal/markets/... -count=1`;
  ...
  skipped because `DATABASE_URL` is unavailable)
- **Active blockers:** none for the authorized public-read slice
- **Next exact action:** define failing bounded catalog sync, rule-hash, and
