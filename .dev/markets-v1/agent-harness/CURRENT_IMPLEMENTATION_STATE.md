...
- **Current task:** MKT-P1-009 — Observability, security controls, CI, and runbooks
...
- **Next exact action:** define failing bounded metrics, readiness alias,
  malformed/oversized upstream, and CI schema/migration gate tests
