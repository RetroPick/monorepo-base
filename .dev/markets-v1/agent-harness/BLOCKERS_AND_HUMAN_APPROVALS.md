...
Track unresolved blockers and human approval gates for implementation agents.
...
|----|-------|-------|-------|--------|
| BLK-001 | Geoblock eligibility upstream not wired | PHASE-2 | backend | open |
| BLK-002 | Android beyond README scaffold | PHASE-5 | android | open |
| BLK-003 | Builder production credentials | PHASE-7 | ops | open |

## Human approval gates

| Gate | Evidence required |
|------|-------------------|
| Production wallet | Address, chain, multisig policy |
| Builder fee config | Current fee schedule + disclosure copy |
| Real transaction | Testnet rehearsal + human sign-off |
| Play production | Closed track metrics + policy review |
