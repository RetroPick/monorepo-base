...
Next.js architecture for Markets routes in apps/web.
...
`apps/web/` monorepo app with product route split.

## 6. Target design

Product shell under `src/products/markets`; OpenAPI-typed client.
