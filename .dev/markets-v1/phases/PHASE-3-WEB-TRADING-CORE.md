...
Phase specification for **PHASE-3**: Order preview, sign, submit, cancel, reconcile on web.

## 2. Scope

### In scope

- Tasks and deliverables assigned to PHASE-3 in [implementation-manifest.yaml](../agent-harness/implementation-manifest.yaml).
...
Order preview, sign, submit, cancel, reconcile on web.
...
- Phase ID `PHASE-3` is locked per master prompt §15.

## 9. Data and control flows

```mermaid
flowchart TB
  Prev[Prior_phase_exit_gate] --> PHASE-3
  PHASE-3 --> Next[Next_phase]
```
