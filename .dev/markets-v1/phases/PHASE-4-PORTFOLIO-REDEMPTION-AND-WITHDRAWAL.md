...
Phase specification for **PHASE-4**: Positions, PnL, split/merge/redeem, withdrawal.

## 2. Scope

### In scope

- Tasks and deliverables assigned to PHASE-4 in [implementation-manifest.yaml](../agent-harness/implementation-manifest.yaml).
...
Positions, PnL, split/merge/redeem, withdrawal.
...
- Phase ID `PHASE-4` is locked per master prompt §15.

## 9. Data and control flows

```mermaid
flowchart TB
  Prev[Prior_phase_exit_gate] --> PHASE-4
  PHASE-4 --> Next[Next_phase]
```
...
- reconciliation with venue
- rounding vectors pass
