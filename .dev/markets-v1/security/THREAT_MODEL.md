...
STRIDE threat model for Markets V1 custody, signing, and data flows.
...
Implementation-grade design for threat model aligned with R0–R3 monorepo.
...
Threats: key exfiltration, preview tampering, eligibility bypass, upstream spoofing.
