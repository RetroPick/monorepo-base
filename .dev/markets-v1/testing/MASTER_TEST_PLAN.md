...
Master test plan across unit, contract, integration, E2E, security, and load.
...
Implementation-grade design for master test plan aligned with R0–R3 monorepo.
...
Pyramid: 70% unit, 20% integration, 10% E2E; conformance on OpenAPI.
