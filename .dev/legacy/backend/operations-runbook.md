...
- [Ops admin dashboard workflow](../../docs/feature/ops-admin-operator-workflow.md) — `apps/ops-web` routes, API mapping, recommended operator sequence, harness agent owners
