...
contract MarketEngineRollingTest is MarketEngineBase {
    function _rollingDirectionTemplate(string memory slug)
        internal
        view
    ...
    function test_rolling_genesis_execute_claim() public {
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("roll"));
    ...
    function test_revert_manual_openEpoch_on_rolling_template() public {
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("r2"));
        bytes32 tid = _tid("r2");
        engine.initializeMarket(tid);
        vm.stopPrank();
    ...
    function test_rolling_buffer_exceeded_halts() public {
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("r3"));
        bytes32 tid = _tid("r3");
        engine.initializeMarket(tid);
        vm.stopPrank();
    ...
    function test_rolling_halt_oracle_failure_execute() public {
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("r_oracle"));
    ...
    function test_rolling_recovery_rebootstrap() public {
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("r_rec"));
    ...
    function test_revert_deposit_when_rolling_halted() public {
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("r_dep"));
    ...
    function test_gas_genesis_start_rolling() public {
        vm.pauseGasMetering();
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("g_gstart"));
    ...
    function test_gas_genesis_lock_rolling() public {
        vm.pauseGasMetering();
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("g_glock"));
    ...
    function test_gas_rolling_execute_one_tick() public {
        vm.pauseGasMetering();
        vm.startPrank(admin);
        engine.upsertTemplate(_rollingDirectionTemplate("rgas"));
