# Markets V1 documentation (pointer)

**Canonical location:** [.dev/markets-v1/](../../.dev/markets-v1/)

All Markets V1 implementation-grade documentation and the agent harness live under `.dev/markets-v1/` per repository convention. Start at:
