...
```yaml
  - id: BLK-001
    ...
    phase: PHASE-2
    doc: ../../../../../../../.harness/products/markets-v1/evidence/verification/PHASE-2/MKT-P2-002-BLK001-evidence.md
```

### 2. Task graph — MKT-P2-002

In `../../../../../../../.harness/products/markets-v1/planning/task-graph.yaml`, for task `MKT-P2-002`:

```yaml
  status: blocked
  verification_evidence:
  - ../../../../../../../.harness/products/markets-v1/evidence/verification/PHASE-2/MKT-P2-002-BLK001-evidence.md
  - ../../../../../../../.harness/products/markets-v1/evidence/verification/PHASE-2/MKT-P2-002-test-output.txt
```
