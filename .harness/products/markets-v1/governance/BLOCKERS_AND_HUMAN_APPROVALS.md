...
| BLK-004 | CLOB V2 submit implemented (orders/clob + BFF glue); gated — live venue credentials + staging proof pending | PHASE-3 | backend | open (implemented; gated) | [ORDER_LIFECYCLE.md](../polymarket/ORDER_LIFECYCLE.md), [MKT-P3-006-exit-gate-analysis.md](verification/PHASE-3/MKT-P3-006-exit-gate-analysis.md) |
