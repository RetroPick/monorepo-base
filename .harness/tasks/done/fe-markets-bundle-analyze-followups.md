...
Run `pnpm --filter web analyze`, identify the largest first-load chunks, then narrow imports or add `next/dynamic` splits without hurting UX.

## Acceptance

- [x] Treemap notes (top 3 chunks + proposed fix) recorded in `apps/web/README.md` or `ORCHESTRATOR.md`.
...
- Documented top chunk roles + mitigation in `apps/web/README.md` (Analyzer follow-ups).
