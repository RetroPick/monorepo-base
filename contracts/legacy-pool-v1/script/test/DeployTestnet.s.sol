...
import {TokenFaucet} from "../../src/mocks/faucet/TokenFaucet.sol";
...
contract DeployTestnet is Script {
    ...
    function _loadEnvConfig() internal view returns (EnvConfig memory c) {
        ...
        require(defFeeRaw <= 200, "DEFAULT_SETTLEMENT_FEE_BPS>200");
        require(maxSwRaw <= 200, "MAX_SWITCH_FEE_BPS>200");
